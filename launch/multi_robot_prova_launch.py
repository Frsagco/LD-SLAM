...
def generate_launch_description():
    ...
    ld_dir = get_package_share_directory('ld_slam')
    ...
    sdf = os.path.join(get_package_share_directory('turtlebot3_gazebo'), 'models/turtlebot3_waffle', 'model.sdf')


    for robot in robots:
        spawn_robots_cmds.append(
            IncludeLaunchDescription(
                PythonLaunchDescriptionSource(os.path.join(ld_dir, 'launch',
    ...
    for robot in robots:
        ...
        group = GroupAction([
            ...
            IncludeLaunchDescription(
                PythonLaunchDescriptionSource(os.path.join(ld_dir,
                                                           'launch',
                                                           'spawn_tb3_prova_launch.py')),
